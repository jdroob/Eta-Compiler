...
public interface IRNodeFactory {
    ...
    IRFuncDecl IRFuncDecl(String name, IRStmt stmt, BlockGraph cfg);
    ...
    String generateFreshHeaderLabel();

    String generateFreshTrueLabel();

    String generateIntermediateFreshTrueLabel();

    String generateIntermediateFreshFalseLabel();

    String generateFreshFalseLabel();

    String generateFreshEndLabel();

    String getCurrentTrueLabel();

    String getCurrentFalseLabel();

    String getCurrentEndLabel();

    IRTemp generateFreshTemp();

    // String generateFreshTemp2();

    String getCurrentLabel();

    String generateFreshLabel();
